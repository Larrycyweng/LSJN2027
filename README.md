# LSJN2027 訓練紀錄（v0.5.0，讀書計畫 v2 2026-09-20）
...
## 讀書計畫 v2（2026-09-20）
- 目標 175+，第一次正式應考 2027 年 4 月 8 日；2027 年 1 月 16 日為內部檢核（CP3b，不計入就緒判定）；申請 2028 年入學。11 月與 1 月場次不參加。
- 每週 15 小時，共 28 週約 425 小時。階段：一（9/20–10/31）LSLAB 影片全部消化進大綱，先 LR 三週再 RC 兩週；二（11/1–12/26）官方應用；三（12/27–3/27）每週一套完整 PT，2 月起乾淨 PT；減量 3/28–4/7。
- 學習順序：LR 先建體系，RC 後。理由：LR 占分數三分之二；RC 的 source 類錯誤多為句子角色未讀出，屬 LR 訓練內容；LR 可體系化程度高。WK1–3 每週保留一篇不計時 RC 維持手感。
- 影片消化方式：每堂截 2 到 3 張投影片加一到三句自己的話，家教當日寫回大綱對應節，來源標「LSATLab Notes：影片《堂名》」。每堂筆記不超過 8 分鐘。
- 就緒標準：3/20 前連續三套乾淨 PT ≥173。未達則評估 2027 年 6 月場次。
